                                ...
                                @foreach ($users as $user)
                                    <tr
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            ...
                                            <button id="dropdownDefaultButt{{ $user->id }}"
                                            ...
                                            <div id="dropdown{{ $user->id }}"
                                                ...
                                                <ul class="justify-content-center py-2 text-sm text-gray-700 dark:text-gray-200"
                                                    ...
                                                    <li>
                                                        <a href="#"
                                                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Statut</a>
                                                    </li>
                                                    <li>
                                                        <a href="#"
